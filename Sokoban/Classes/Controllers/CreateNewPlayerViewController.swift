...
UINavigationControllerDelegate {
    ...
    @IBAction func createNewPlayerButtonTapped(_ sender: UIButton) {
        alertWhenPlayerNameIsNotWritten()
        addImageForPlayer()
        checkIsPlayerExist()
    }
    
    func checkIsPlayerExist () {
    ...
    func alertWhenPlayerNameIsNotWritten () {
    ...
    override func viewDidLoad() {
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(CreateNewPlayerViewController.dismissKeyboard))
